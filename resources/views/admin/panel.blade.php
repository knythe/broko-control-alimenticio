...
<div class="container-xl">
    ...
    <h1 class="app-page-title">Panel</h1>
            ...
            <div class="app-card app-card-basic d-flex flex-column align-items-start shadow-sm">
                <div class="app-card-header p-3 border-bottom-0">
                    <div class="row align-items-center gx-3">
                        ...
                        <div class="col-auto">
                            <h4 class="app-card-title">Usuarios</h4>
                        </div><!--//col-->
                    </div><!--//row-->
                </div><!--//app-card-header-->
            ...
            <div class="app-card app-card-basic d-flex flex-column align-items-start shadow-sm">
                <div class="app-card-header p-3 border-bottom-0">
                    <div class="row align-items-center gx-3">
                        ...
                        <div class="col-auto">
                            <h4 class="app-card-title">Comidas</h4>
                        </div><!--//col-->
                    </div><!--//row-->
                </div><!--//app-card-header-->
                <div class="app-card-body px-4">

                    <div class="intro">Crear recetas</div>
                </div><!--//app-card-body-->
                <div class="app-card-footer p-4 mt-auto">
                    <a class="btn app-btn-secondary" href="/v1/recetas">Create Recetas</a>
                </div><!--//app-card-footer-->
            </div><!--//app-card-->
        </div><!--//col-->
        <div class="col-12 col-lg-4">
            <div class="app-card app-card-basic d-flex flex-column align-items-start shadow-sm">
                ...
                <div class="app-card-body px-4">
                    ...
                    <div class="intro">Sed maximusss, libero ac pharetra elementum, turpis nisi molestie neque, et tincidunt velit turpis non enim.</div>
                </div><!--//app-card-body-->
                <div class="app-card-footer p-4 mt-auto">
                    <a class="btn app-btn-secondary" href="#">Create New</a>
                </div><!--//app-card-footer-->
